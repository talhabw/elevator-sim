...
impl ElevatorPhysics {
    pub fn new(mass: f64, position: f64, voltage: f64) -> Self {
        Self {
            mass,
            gravity: 9.81,
            motor_constant: 100.0, // Adjust for realistic behavior
    ...
    pub fn update(&mut self, dt: f64) {
        ...
        let friction_force = self.friction_coefficient * self.velocity;

        // Net force (assuming up is positive)
        let net_force = motor_force - gravity_force - friction_force;
